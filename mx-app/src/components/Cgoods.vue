<template>
    <div>
        <div class="img"><img src="../assets/cgoods.jpg" alt=""></div>

        <div class="secondNav">
            <ul>
                <li class="SecActive">中国现货</li>
            </ul>
        </div>
  ...
  methods: {
    async shopList() {
      ...
      const data = await this.$axios(
        "https://www.easy-mock.com/mock/5cff632478b24c0691f353a6/moxishoplist/cgoods"
      );
      const cjoodsshoplist = data.data;
