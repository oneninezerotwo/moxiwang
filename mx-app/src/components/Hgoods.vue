<template>
    <div>
        <div class="img"><img src="../assets/hgoods.jpg" alt=""></div>

        <div class="secondNav">
            <ul>
                <li v-for="(i,index) in hgoodsnav" 
                :key="index" 
                :class="{SecActive : num === index}" 
                v-text="i.title"
         ...
         <div class="commodity" v-show = "situation">
            <ul class="inCommodity">
                <li v-for="(i,index) in hgoodsshop" :key="index" productid="i.id" class="inCommodityList"
...
export default {
  ...
  methods:{
      ...
      const data = await this.$axios(
        "https://www.easy-mock.com/mock/5cff632478b24c0691f353a6/moxishoplist/hgoods"
      );
      const hgoodsshoplist = data.data;
      console.log(data.data);
      this.hgoodsshop = [...hgoodsshoplist];
      this.$store.state.loading -= 1;
    },
