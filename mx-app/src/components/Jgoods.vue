<template>
    <div>
        <div class="img"><img src="../assets/jgoods.jpg" alt=""></div>

        <div class="secondNav">
            <ul>
                <li class="SecActive">日本现货</li>
            </ul>
        </div>

        <div class="commodity">
            <ul class="inCommodity">
                <li v-for="(i,index) in jgoodsshop" :key="index" productid="i.id" class="inCommodityList"
  ...
  methods: {
    async shopList() {
      ...
      const data = await this.$axios(
        "https://www.easy-mock.com/mock/5cff632478b24c0691f353a6/moxishoplist/joods"
      );
      const jgoodsshoplist = data.data;
      console.log(data.data);
      this.jgoodsshop = [...jgoodsshoplist];
      this.$store.state.loading -= 1;
    },
